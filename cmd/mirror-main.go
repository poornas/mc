...
func newMirrorJob(srcURL, dstURL string, isFake, isRemove, isOverwrite, isWatch bool, excludeOptions []string, olderThan, newerThan int, encKeydb map[string][]prefixSSEPair) *mirrorJob {
