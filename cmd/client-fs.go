...
func (f *fsClient) Put(ctx context.Context, reader io.Reader, size int64, metadata map[string]string, progress io.Reader, sseKey map[string]string) (int64, *probe.Error) {
...
func (f *fsClient) Copy(source string, size int64, progress io.Reader, srcSSEKeys, tgtSSEKeys map[string]string) *probe.Error {
...
func (f *fsClient) Get(sseKey map[string]string) (io.Reader, *probe.Error) {
	return f.get()
}
...
func (f *fsClient) Stat(isIncomplete, isFetchMeta bool, sseKeyMap map[string]string) (content *clientContent, err *probe.Error) {
